...
ifelse_one_arg:                ifelse(`bla bla')
ifelse_two_args:               ifelse(`bla bla',`error?')
ifelse_three_args_true:        ifelse(`foo',`foo',`yes')
ifelse_three_args_false:       ifelse(`foo',`bar',`error')
ifelse_four_args_true:         ifelse(`foo',`foo',`yes',`error')
ifelse_four_args_false:        ifelse(`foo',`bar',`error',`no')
ifelse_five_args:              ifelse(`foo',`foo',`yes',`no',`error')
